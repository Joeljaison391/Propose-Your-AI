...
export default function HomeScreen() {
    ...
    const validateConfiguration = (): FormValidation => {
        if (!gameData.userName.trim()) {
            return { isValid: false, message: "Please enter your name" };
        }
        if (!gameData.aiName.trim()) {
            return { isValid: false, message: "Please name your AI companion" };
        }
        if (!gameData.userGender) {
            return { isValid: false, message: "Please select your gender" };
        }
        if (!gameData.aiModel) {
            return { isValid: false, message: "Please select an AI model" };
        }
        return { isValid: true, message: "Configuration complete!" };
    };
    ...
    const handleSubmit = () => {
        ...
        if (validation.isValid) {
            // Initialize the chat with current game data
            initiateChat({
                userName: gameData.userName,
                aiName: gameData.aiName,
                userGender: gameData.userGender,
                aiModel: gameData.aiModel,
                userPersonality: gameData.userPersonality,
                aiBehavior: gameData.aiBehavior
            });
            navigate('/chat');
        }
    };

    const formValidation = validateConfiguration();
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-neon-green font-mono p-8">
            ...
            <p className="text-lg text-center text-neon-blue pb-4">
                Find out how well you can impress your AI with your conversational skills! Fill out the form below to get started.
            </p>

            <section className="max-w-2xl mx-auto bg-gray-800 p-6 rounded-lg border-2 border-neon-purple mb-8">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <Select 
                            onValueChange={(value) => handleSelectChange(value, 'userGender')}
                            value={gameData.userGender}
                        >
                            <SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <Select 
                            onValueChange={(value) => handleSelectChange(value, 'aiModel')}
                            value={gameData.aiModel}
                        >
                            <SelectTrigger>
            ...
            <section className="max-w-2xl mx-auto bg-gray-800 p-6 rounded-lg border-2 border-neon-purple">
                <h2 className="text-2xl mb-4 flex items-center">
                    <Zap className="mr-2" />
                    Configuration
                </h2>
            ...
            <section className="max-w-2xl mx-auto mt-8 bg-gray-800 p-6 rounded-lg border-2 border-neon-purple">
                <h2 className="text-2xl mb-4 flex items-center">
                ...
                <ul className="list-none space-y-2">
                    <li className="flex items-center">
                        ...
                        Maximum {gameConfig.maxConversations} messages allowed
                    </li>
                    <li className="flex items-center">
                        <AlertTriangle className="mr-2 text-neon-blue" />
                        Stay within {gameConfig.maxTokensPerMessage} tokens per message
                    </li>
                    <li className="flex items-center">
